...
console.log(
  'albert elinstein once said,"A person who never made a mistake never tired anything news."'
);
...
console.log(
  invitation[0] + " I Would like to invite on dinner at 8:00pm clock"
);
...
const favorite_fruits = ['blueberries', 'apples', 'peaches']
...
let usernames = ['eric', 'admin', 'sana', 'omer', 'hamna']
...
let current_users = ['omer', 'ali', 'ahmed', 'saad', 'maaz']
let new_users = ['sara', 'fatima', 'ALI', 'anus', 'saad']
let current_users_upper
for (let num1 = 0; num1 < current_users.length; num1++) {
    current_users_upper = current_users.map(user =>user.toUpperCase())
}

for (let num2 = 0; num2 < current_users.length; num2++) {
for (let num3 = 0; num3 < current_users_upper.length; num3++){
if (new_users[num2] === current_users[num3]){
    console.log("Sorry " + new_users[num2] + ", that name is taken.")
    break;
}
else if(new_users[num2] === current_users_upper[num3])
{
    console.log("Sorry " + new_users[num2] + ", that name is taken.")
break;
...
console.log ("This name " + new_users[num2]   +  " is still available")
...
*/
let favorite_pizzas = ['pepperoni', 'tikka', 'afghani']
...
const make_shirt = (size: string , text_of_shirt: string):void =>
 {
  ...
  let text_of_shirt: string = 'tiger'
...
*/
const make_shirt1 = (size: string ='Large', text_of_shirt: string='I Love Typescript'):void =>
 {
     console.log('The size of the shirt is:' +size, 'and the text printed on it is '+ text_of_shirt);
...
const describe_city = (city: string , country: string ) :void =>
{
...
const album1 = make_album('Eminem','joy')
console.log(album1)
const album2 = make_album('Nusrat','Jani')
console.log(album2)
const album3 =  make_album('Atif','Afreen')
console.log(album3)

function make_albumN(artist: string, title: string, tracks: number)
    {
    const album = {artist , title , tracks}

    return album
  }
const album4 = make_albumN('Atif','Afreen',4)
console.log(album4)
...
const magicians_Names = ['Darren Brown','Penn & Teller','David Copperfield','Criss Angel']
...
const greatmagician_names:string[] =make_great(magicians_Names)
...
const mycar :string =Car('suzuki','Mehran',['color','red'],['doors',4])
console.log(mycar);